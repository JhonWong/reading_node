...
作为一名hacker是很有趣的事情，这种乐趣需要付出努力。努力需要动力。成为一名hacker要学会从解决问题、磨炼技能、锻炼智力中获取快感。这种快感会成为付出努力的动力。

如果不能找到这种感觉，那么你的精力将会被别的东西分散掉。

(You also have to develop a kind of faith in your own learning capacity — a belief that even though you may not know all of what you need to solve a problem, if you tackle just a piece of it and learn from that, you'll learn enough to solve the next piece — and so on, until you're done.)

（遇到自己不能解决的问题的时候，就要从一小块入手，解决并从中学习到知识，然后开始下一块，依次直到问题解决。要学会拆分问题，然后一点一点的去解决问题）

**2.No problem should ever have to be solved twice.**

Creative brains are a valuable, limited resource.

创造性的大脑是珍贵的，不应该浪费在重复的事情中。

To behave like a hacker, you have to believe that the thinking time of other hackers is precious — so much so that it's almost a moral duty for you to share information, solve problems and then give the solutions away just so other hackers can solve *new* problems instead of having to perpetually re-address old ones.

其他hacker的思考时间是珍贵的，要学会分享信息，让其他的hacker可以有时间去思考新的问题。

Note, however, that "No problem should ever have to be solved twice." does not imply that you have to consider all existing solutions sacred, or that there is only one right solution to any given problem. Often, we learn a lot about the problem that we didn't know before by studying the first cut at a solution. It's OK, and often necessary, to decide that we can do better. What's not OK is artificial technical, legal, or institutional barriers (like closed-source code) that prevent a good solution from being re-used and *force* people to re-invent wheels.

确定我们是否可以做的更好也是很正常的。学习之前的解决方案很多时候也很有用。这往往会让我们了解到很多我们之前并没有考虑到的问题。
...
被迫接受一些命令，并且放弃自己所迷恋的问题是有限度的。

**5. Attitude is no substitute for competence.**

To be a hacker, you have to develop some of these attitudes. But copping an attitude alone won't make you a hacker, any more than it will make you a champion athlete or a rock star. Becoming a hacker will take intelligence, practice, dedication, and hard work.

态度不能取代能力。成为一名hacker同样需要除了态度外的很多别的东西。
...
If you don't know any computer languages, I recommend starting with Python. It is cleanly designed, well documented, and relatively kind to beginners.I think it is probably best to learn C and Lisp first, then Java.

If a language does too much for you, it may be simultaneously a good tool for production and a bad one for learning.It's not only languages that have this problem; web application frameworks like RubyOnRails, CakePHP, Django may make it too easy to reach a superficial sort of understanding that will leave you without resources when you have to tackle a hard problem, or even just debug the solution to an easy one.

如果一个语言为你做了太多的事情，那么这个语言就是一个强大的工具，但是不适合学习。

If you get into serious programming, you will have to learn C, the core language of Unix. C++ is very closely related to C;  Neither language is a good one to try learning as your first, however. And, actually, the more you can avoid programming in C the more productive you will be.

C is very efficient, and very sparing of your machine's resources. Unfortunately, C gets that efficiency by requiring you to do a lot of low-level management of resources (like memory) by hand. All that low-level code is complex and bug-prone, and will soak up huge amounts of your time on debugging. With today's machines as powerful as they are, this is usually a bad tradeoff — it's smarter to use a language that uses the machine's time less efficiently, but your time much *more* efficiently. Thus, Python.

C语言对于机器来说是很高效的，但对于程序员来说就效率太低了。最好能选择一个对人来说高效的语言——Python.
...
Perl 和LISP也很重要。对于Perl，至少要能读懂它。而LISP则具有很大的启蒙意义。
